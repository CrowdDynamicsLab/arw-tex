...
% TODO: parameter fitting of baselines; undirected to directed
...
create directed edges and generate directed networks (TODO). Fitting (TODO)

\textit{Evaluation}.
% TODO: weighted relative error explain
