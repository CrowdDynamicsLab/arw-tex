...
All networks in~\Cref{table:netstats} exhibit heavy tailed degree distributions.
...
(\texttt{LCC}), as shown in~\Cref{table:netstats}. We can explain local
...
network properties described in~\Cref{subsec:factors}.
