...
of edge formation under resource constraints. Furthermore, both sets of models do not \textit{jointly} preserve multiple structural properties. Developing a parsimonious,
...
\texttt{ARW} jointly and accurately preserves
...
Then, in~\Cref{sec:Proposed Model}, we describe the network growth model. We follow by presenting experiments~\Cref{sec:Experiments}, analysis of assortative mixing~\Cref{subsec:LocalMixing}
and discussion in~\Cref{sec:Discussion}. We conclude in~\Cref{sec:Conclusion}.
