...
\begin{figure*}[t]
	\vspace{-25pt}
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=.99\textwidth]{experiments_final3}}
	\vspace{-16pt}
	\caption{
...
The experiment results in~\Cref{fig:exp_table} clearly indicate the effectiveness
...
\begin{figure}
	\centering
	\vspace{-16pt}
	\includegraphics[width=.65\linewidth]{barplots_final3}
