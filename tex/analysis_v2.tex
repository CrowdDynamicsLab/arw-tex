...
\textbf{Heavy tailed degree distribution:} All citation datasets in~\Cref{table:netstats} exhibit heavy tailed degree distributions. These distributions arise out of the well known preferential attachment process~\cite{simon1955class,barabasi1999emergence}, where, incoming nodes connect with nodes in proportion to their degree. As a result, initial differences in node
